...
const KulturSanatTopluluklari = () => {
  ...
  const fetchTopluluklar = async () => {
    try {
      const topluluk = process.env.REACT_APP_TOPLULUK_KATEGORI + "/Kultur-Sanat";
    ...
    >
      ...
      <div className="page-container">
        <div className="page-header">
          <h1 className="page-title">🎨 Kültür & Sanat Toplulukları</h1>
          <p className="page-subtitle">Sanatsal ve kültürel etkinlikler odaklı topluluklar</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="notification is-warning has-text-centered mt-5">
            <h3>❌ Hiç kültür-sanat topluluğu bulunamadı.</h3>
...
export default KulturSanatTopluluklari;
